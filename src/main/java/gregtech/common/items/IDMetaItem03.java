...
public enum IDMetaItem03 {
    ...
    Circuit_Chip_APIC(269),
    Circuit_Wafer_ZPIC(270),
    Circuit_Chip_ZPIC(271),
    Circuit_Wafer_YPIC(272),
    Circuit_Chip_YPIC(273),
    Circuit_Wafer_PlPIC(274),
    Circuit_Chip_PlPIC(275),
    Circuit_Silicon_Wafer8(276),
    Gravitational_Lens(277),
    Planck_Manifold(278),
    Resonant_Stable_Seed(279),
    Bubble_Capsule_Polymer_Full(280),
    Bubble_Capsule_Polymer_Empty(281),
    ...
    MetaMaterial_Shielding1(307),
    MetaMaterial_Shielding2(308),
    MetaMaterial_Shielding3(309),
    MetaMaterial_Waveguide1(310),
    MetaMaterial_Waveguide2(311),
    MetaMaterial_Waveguide3(312),
    MetaMaterial_EnergyConduit1(313),
    MetaMaterial_EnergyConduit2(314),
    MetaMaterial_EnergyConduit3(315),
    MetaMaterial_ElectrograviticValve1(316),
    MetaMaterial_ElectrograviticValve2(317),
    MetaMaterial_ElectrograviticValve3(318),
    MetaMaterial_WaveFocus1(319),
    MetaMaterial_WaveFocus2(320),
    MetaMaterial_WaveFocus3(321),
    MetaMaterial_WaveFocus4(322),
    MetaMaterial_ResonanceChamber1(323),
    MetaMaterial_ResonanceChamber2(324),
    MetaMaterial_ResonanceChamber3(325),
    MetaMaterial_ResonanceChamber4(326),
    MetaMaterial_SensorArray1(327),
    MetaMaterial_SensorArray2(328),
    MetaMaterial_SensorArray3(329),
    MetaMaterial_SensorArray4(330),
    MetaMaterial_FieldManipulator1(331),
    MetaMaterial_FieldManipulator2(332),
